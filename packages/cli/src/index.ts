...
const commandNames = ['init', 'inspect', 'observe', 'board', 'route', 'revise', 'status', 'transition', 'claim', 'run-gates', 'submit', 'review', 'approve', 'waive', 'resolve', 'reconcile', 'resume', 'team', 'doctor'];
