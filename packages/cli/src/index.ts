...
async function main(): Promise<void> {
  try {
    ...
    commandResult = (program.getOptionValue('__result') as CommandResult | undefined) ?? commandResult;
