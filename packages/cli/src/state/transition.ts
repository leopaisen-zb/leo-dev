...
const change: Record<ChangeState, readonly ChangeState[]> = {
  triage: ['discovery', 'approval-required', 'blocked'], discovery: ['spec-review', 'approval-required', 'blocked'], 'spec-review': ['spec-approved', 'approval-required', 'blocked'], 'spec-approved': ['task-ready', 'design-review', 'approval-required', 'blocked'], 'design-review': ['spec-approved', 'design-approved', 'approval-required', 'blocked'], 'design-approved': ['task-ready', 'approval-required', 'blocked'], 'task-ready': ['executing', 'approval-required', 'blocked'], executing: ['integration-review', 'approval-required', 'blocked'], 'integration-review': ['release-evidence', 'approval-required', 'blocked'], 'release-evidence': ['archived', 'approval-required', 'blocked'], archived: [], 'approval-required': [], blocked: [],
};
...
export function transitionChange(from: ChangeState, to: string, recovery: TransitionContext = {}): TransitionResult {
  ...
  if (from === 'design-review' && to === 'spec-approved') return recovery.rejectReviewReceiptMatches ? adjacent : denied('design rejection receipt must match');
